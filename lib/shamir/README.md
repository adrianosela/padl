Adapted from [SOPS](https://github.com/mozilla/sops/tree/master/shamir) which was initially forked from [Vault](https://github.com/hashicorp/vault/tree/master/shamir)
